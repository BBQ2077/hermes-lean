@echo off
REM One-click re-apply of compact Hermes tool & prompt descriptions (Windows).
REM Double-click this file after running `hermes update`.
setlocal
set HERE=%~dp0
set PY=
